...
;extern void near  I2C0_ISR(void);                  /* I2C0 ISR             */

extern void near  SCI0_ISR(void);                  /* SCI0 ISR             */
extern void near  SCI2_ISR(void);                  /* SCI2 ISR             */

extern void near  ECT0_ISR(void);                  /* ECT0 ISR             */
extern void near  ECT1_ISR(void);                  /* ECT1 ISR             */
extern void near  ECT2_ISR(void);                  /* ECT2 ISR             */
extern void near  ECT3_ISR(void);                  /* ECT3 ISR             */

extern void near  Can0_TxISR(void);                /*CAN 0 transmit        */
extern void near  Can0_RxISR(void);                /*CAN 0 Receive         */
extern void near  Can0_ErrorISR(void);             /*CAN 0 ¥ÌŒÛ÷–∂œ        */

extern void near  Can1_TxISR(void);                /*CAN 1 transmit        */
extern void near  Can1_RxISR(void);                /*CAN 1 Receive         */
extern void near  Can1_ErrorISR(void);             /*CAN 1 ¥ÌŒÛ÷–∂œ        */

extern void near  Can2_TxISR(void);                /*CAN 2 transmit        */
extern void near  Can2_RxISR(void);                /*CAN 2 Receive         */
extern void near  Can2_ErrorISR(void);             /*CAN 2 ¥ÌŒÛ÷–∂œ        */

extern void near  Can3_TxISR(void);                /*CAN 3 transmit        */
extern void near  Can3_RxISR(void);                /*CAN 3 Receive         */
extern void near  Can3_ErrorISR(void);             /*CAN 3 ¥ÌŒÛ÷–∂œ        */

extern void near  Can4_TxISR(void);                /*CAN 4 transmit        */
extern void near  Can4_RxISR(void);                /*CAN 4 Receive         */
extern void near  Can4_ErrorISR(void);             /*CAN 4 ¥ÌŒÛ÷–∂œ        */
...
const tIsrFunc _vect[] @0xFF10 = {
        ...
        Can4_TxISR,               /* 0x90: CAN 4 transmit                         */        
        Can4_RxISR,               /* 0x92: CAN 4 receive                          */
        Can4_ErrorISR,            /* 0x94: CAN 4 errors                           */
        software_trap96,               /* 0x96: CAN 4 wake-up                          */
        Can3_TxISR,               /* 0x98: CAN 3 transmit                         */        
        Can3_RxISR,               /* 0x9A: CAN 3 receive                          */
        Can3_ErrorISR,            /* 0x9C: CAN 3 errors                           */
        software_trap9E,               /* 0x9E: CAN 3 wake-up                          */
        Can2_TxISR,               /* 0xA0: CAN 2 transmit                         */        
        Can2_RxISR,               /* 0xA2: CAN 2 receive                          */
        Can2_ErrorISR,            /* 0xA4: CAN 2 errors                           */
        software_trapA6,               /* 0xA6: CAN 2 wake-up                          */
        Can1_TxISR,               /* 0xA8: CAN 1 transmit                         */        
        Can1_RxISR,               /* 0xAA: CAN 1 receive                          */
        Can1_ErrorISR,            /* 0xAC: CAN 1 errors                           */
        software_trapAE,               /* 0xAE: CAN 1 wake-up                          */
        Can0_TxISR,               /* 0xB0: CAN 0 transmit                         */        
        Can0_RxISR,               /* 0xB2: CAN 0 receive                          */
        Can0_ErrorISR,      	  /* 0xB4: CAN 0 errors                           */
        ...
        OSTickISR,                     /* 0xE0: Standard Timer Channel 7. Generally    */
        ...
        ECT3_ISR,               /* 0xE8: Standard Timer Channel 3               */        
        ECT2_ISR,               /* 0xEA: Standard Timer Channel 2               */
        ECT1_ISR,               /* 0xEC: Standard Timer Channel 1               */
        ECT0_ISR,               /* 0xEE: Standard Timer Channel 0               */ 
