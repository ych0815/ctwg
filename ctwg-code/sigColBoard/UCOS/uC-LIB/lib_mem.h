...
struct  mem_pool {
    ...
    void           *PoolAddrPtr;                                        /* Ptr  to mem seg's addr for mem pool blks.    */
    ...
    MEM_POOL_IX     BlkIx;                                              /* Ix into mem pool's array of blk ptrs.        */
                                                                        /* ----------------- MEM SEG ------------------ */
    void           *SegAddrPtr;                                         /* Ptr      to mem seg's base/start addr.       */
    void           *SegAddrNextAvailPtr;                                /* Ptr      to mem seg's next avail addr.       */
